...
Public Class LaporPertahun
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPelanggan.LaporPertahun.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporPertahun
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporPertahun = New LaporPertahun()
        rpt.Site = Me.Site
        Return rpt
    End Function
