...
Public Class LaporPerbulan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPelanggan.LaporPerbulan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporPerbulan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporPerbulan = New LaporPerbulan()
        rpt.Site = Me.Site
        Return rpt
    End Function
